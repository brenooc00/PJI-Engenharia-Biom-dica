...
select_shapiro(teste_normalidade_controle, "controle")
select_shapiro(teste_normalidade_problema, "problema")
...
#Aqui já estamos verificando um sumário da ANOVA entre o atributo MIC1 e o Grupo. Ele nos informa
#Se há diferença estatisticamente significativa entre os grupos ou não com base no Pr(>F)
...
#Semelhante ao caso anterior, podemos verificar a diferença entre cada par de grupo individualmente
...
# Visualizando os boxplots das características ----------------------------
#Aqui utilizamos a biblioteca ggplot pela praticidade em plotagem dos dados
#Como queremos visualizar o boxplot, primeiro criamos a instância ggplot, determinando o conjunto de dados,
#E qual coluna está nos eixos X e Y. Feito isso, iremos transformar esses dados em um boxplot utilizando o geom_boxplot()
ggplot(atributos, aes(x = Grupo, y = DIF_QUARTIL)) +
  geom_boxplot() +
  theme_bw()  #O tema é só pra deixar tudo mais bonito mesmo
